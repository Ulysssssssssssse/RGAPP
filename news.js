...
const apiUrl = `https://newsapi.org/v2/everything?q=${encodeURIComponent(searchTerm)}&sortBy=publishedAt&apiKey=92e47a9623ed4cb487bc9a60f6a7166b`;  // Remplacez YOUR_API_KEY par votre clé API
